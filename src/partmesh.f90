...
!   - can be optimise further the detect_ghost routine
program partmesh
!use set_precision
use string_library
use partmesh_scotch,only: npart,inp_path,out_path,out_phead, &
read_mesh_files,check_valence,scotch_partitioning, &
...
integer :: bc_stat,preinfo_stat,mesh_stat,material_stat,traction_stat
...
write(*,*)'complete!'
write(*,*)'partition directory: ',out_path
